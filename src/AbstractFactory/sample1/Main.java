...
public class Main {
    public static void main(String[] args) {
        if (args.length != 2) {
            ...
            System.out.println("Example 1: java Main list.html AbstractFactory.sample1.listfactory.ListFactory");
            System.out.println("Example 2: java Main div.html AbstractFactory.sample1.divfactory.DivFactory");
            System.exit(0);
        }
